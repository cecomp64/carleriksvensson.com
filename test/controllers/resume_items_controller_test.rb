...
class ResumeItemsControllerTest < ActionController::TestCase
  ...
  test "should create resume_item" do
    assert_difference('ResumeItem.count') do
      post :create, resume_item: { description: @resume_item.description, end: @resume_item.end, job_title: @resume_item.job_title, location: @resume_item.location, start: @resume_item.start }
    end
  ...
  test "should update resume_item" do
    patch :update, id: @resume_item, resume_item: { description: @resume_item.description, end: @resume_item.end, job_title: @resume_item.job_title, location: @resume_item.location, start: @resume_item.start }
    assert_redirected_to resume_item_path(assigns(:resume_item))
  end
