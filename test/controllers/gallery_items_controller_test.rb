...
class GalleryItemsControllerTest < ActionController::TestCase
  ...
  test "should create gallery_item" do
    assert_difference('GalleryItem.count') do
      post :create, gallery_item: { cover: @gallery_item.cover, description: @gallery_item.description, gallery_id: @gallery_item.gallery_id, title: @gallery_item.title }
    end
  ...
  test "should update gallery_item" do
    patch :update, id: @gallery_item, gallery_item: { cover: @gallery_item.cover, description: @gallery_item.description, gallery_id: @gallery_item.gallery_id, title: @gallery_item.title }
    assert_redirected_to gallery_item_path(assigns(:gallery_item))
  end
